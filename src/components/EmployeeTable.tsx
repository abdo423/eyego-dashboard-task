...
export default function EmployeeTable() {
  ...
  useEffect(() => {
    dispatch(fetchEmployees({ page: currentPage, limit, sortBy, order, search }));
  ...
  const handlePrevious = () => {
    if (currentPage > 1) {
      dispatch(fetchEmployees({ page: currentPage - 1, limit, sortBy, order, search }));
    }
  };
  ...
  return (
    <>
      ...
      <Card className="border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <CardHeader className="text-xl sm:text-2xl bg-white px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            >
